...
if __name__ == "__main__":
    ...
    if args.out_h5fn is None:
        args.out_h5fn = args.h5fn.replace("data.h5", f"semantics_{args.side}.h5")
    ...
    for idx in tqdm(range(total_images), total=total_images):
        ...
        # intern_image_inference_save(args, model, input_image, result, idx)
